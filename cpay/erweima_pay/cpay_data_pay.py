...
class zhifubao(unittest.TestCase):
    ...
    def test_zhifubao(self):
        ...
        for erweima in erweimas:
            ...
            if houtai.cpay.common.isElementExist.isElementExist(self, element01):
                pass
            else:
                lianjies[-1].click()
                time.sleep(2)
            ...
            if houtai.cpay.common.isElementExist.isElementExist(self, element02):
                print "付款账号余额不足，请充值！"
                time.sleep(3)
            else:
                pass
            element="//android.widget.TextView[@text='开通指纹支付']"
            if houtai.cpay.common.isElementExist.isElementExist(self, element):
